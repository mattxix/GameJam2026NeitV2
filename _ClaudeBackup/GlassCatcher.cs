...
public class GlassCatcher : MonoBehaviour
{
    ...
    [Tooltip("How full the glass must be for the tutorial's Pour step to count (0-1).")]
    [Range(0f, 1f)] public float tutorialPourFill = 0.8f;
    ...
    void OnParticleCollision(GameObject other)
    {
        ...
        // Tutorial: the pour counts once the glass is full enough.
        if (liquid.Fill >= tutorialPourFill)
            TutorialManager.Instance?.Complete(TutorialStep.PourDrink);
    }
}